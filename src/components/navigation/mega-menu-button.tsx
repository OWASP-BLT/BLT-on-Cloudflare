    ...
    },
    {
        sections: [
            ...
            },
            {
                title: "Users",
                items: [
                    { label: "Users", href: "/users/", icon: "fas fa-user-group" },
        ...
        sections: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { label: "OWASP Project", href: "https://owasp.org/www-project-bug-logging-tool/", icon: "fas fa-shield-halved", external: true },
            ...
            },
            {
                ...
                items: [
                    ...
                    { label: "Edit this page", href: "https://github.com/OWASP-BLT/BLT/blob/main/website/templates/", icon: "fas fa-pen-to-square", external: true },
                ],
            },
        ],
    },
        ...
        sections: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { label: "BLT Flutter", href: "https://github.com/OWASP-BLT/BLT-Flutter", icon: "fas fa-mobile-screen-button", external: true },
                                            ...
                                            {section.title === "Users" && (
                                                <div className="mt-6">
                                                    ...
                                                    <div className="flex items-center">
                                                        <i className="fas fa-earth-americas w-5 mr-2 text-gray-700" aria-hidden="true"></i>
                                                        <select
