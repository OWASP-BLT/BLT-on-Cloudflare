...
export default function LeaderboardSection({
  ...
  const { data: topEarnersData } = useTopEarners();
  const { data: topBugReportersData } = useTopBugReporters();
  const { data: topPRContributorsData } = useTopPRContributors();
  const { data: topReferralsData } = useTopReferrals();
